...
public class BaseObjectHandler {
   ...
   * 
   * @param doc
   *          XWikiDocument with attached objects.
   * @param tagName
   *          Name of the tag.
   * @return Description (value) of the searched tag.
   * @throws XWikiException
   */
  public String getDescriptionFromBaseObjectList(XWikiDocument doc, String tagName)
      throws XWikiException {
   ...
   * @throws XWikiException
   */
  public BaseObject getBaseObjectFromBaseObjectList(XWikiDocument doc, String tagName)
      throws XWikiException {
    List<BaseObject> metaTags = doc.getXObjects(ImageLibStrings.getMetainfoClassDocRef());
    if (metaTags != null) {
      for (Iterator<BaseObject> iter = metaTags.iterator(); iter.hasNext();) {
        BaseObject tag = iter.next();
        if ((tag != null) && tag.getStringValue(ImageLibStrings.METAINFO_CLASS_NAME).equals(
            tagName)) {
          return tag;
        }
      }
   ...
   * 
   * @param doc
   *          XWikiDocument to attach the object to.
   * @param name
   *          Name of the objet to create.
   * @param value
   *          The value to set.
   * @param context
   *          XWikiContext
   ...
   * @throws XWikiException
   */
  public BaseObject addBaseObject(XWikiDocument doc, String name, String value,
      XWikiContext context) throws XWikiException {
    BaseObject celementsMeta = doc.newXObject(ImageLibStrings.getMetainfoClassDocRef(), context);
   ...
   * 
   * @param doc
   *          XWikiDocument, the object attends to.
   * @param obj
   *          The object needing an update.
   * @param value
   ...
   * @throws XWikiException
   */
  public void updateBaseObject(XWikiDocument doc, BaseObject obj, String value,
      XWikiContext context) throws XWikiException {
    if (obj != null) {
   ...
   * @throws XWikiException
   */
  public void updateBaseObject(XWikiDocument doc, String name, String value, XWikiContext context)
      throws XWikiException {
   ...
   *          Name of the tag.
   * @param value
   *          Value to set the tag to.
   * @param context
   *          XWikiContext
   * @throws XWikiException
   */
  public void setImageString(XWikiDocument doc, String tag, String value, XWikiContext context)
      throws XWikiException {
    BaseObject obj = doc.getXObject(ImageLibStrings.getImageClassDocRef());
    if (obj != null) {
   ...
   * @throws XWikiException
   */
  public void setImageBoolean(XWikiDocument doc, String tag, boolean value, XWikiContext context)
      throws XWikiException {
    BaseObject obj = doc.getXObject(ImageLibStrings.getImageClassDocRef());
    if (obj != null) {
   ...
   * @throws XWikiException
   */
  public void setImageInteger(XWikiDocument doc, String tag, int value, XWikiContext context)
      throws XWikiException {
    BaseObject obj = doc.getXObject(ImageLibStrings.getImageClassDocRef());
    if (obj != null) {
